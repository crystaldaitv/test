...
if (!class_exists('ThemeUpdateChecker')) {
     ...
     */
    class ThemeUpdateChecker // phpcs:ignore Generic.Files.OneClassPerFile.MultipleFound -- some classes have no function
    {
        /**
         * Theme name
         *
        ...
        /**
         * The URL of the theme's metadata file.
         *
         * @var string
         */
        ...
        public function __construct($theme, $metadataUrl, $enableAutomaticChecking = true)
        {
            ...
            $this->theme                   = $theme;
            $this->optionName              = 'external_updates-' . $this->theme;
         ...
         *
         * @param mixed $value Val of _site_transient_update_themes option
         *
         * @return mixed
         */
         ...
         * It should return a modified array of query arguments.
         *
         * @param callable $callback Function is called
         *
         * @return void
         */
        public function addQueryArgFilter($callback)
...
if (!class_exists('ThemeUpdate')) {
     ...
     * A simple container class for holding information about an available update.
     */
    class ThemeUpdate // phpcs:ignore Generic.Files.OneClassPerFile.MultipleFound -- some classes have no function
    {
        /**
         * Version number
         *
        ...
        public function toWpFormat()
        {
            ...
            /*edited when have json string*/
            if (!empty($this->download_url)) {
                $update['package'] = $this->download_url . '&token=' . $token;
            } else {
                $update['package'] = $this->download_url;
            }
            /*end edit*/
